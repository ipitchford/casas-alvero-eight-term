"""Lift every residual Frobenius orbit through at most four 17-adic digits."""
...
def main():
    ...
    presentation=json.loads((HERE.parent/'elimination/presentation.json').read_text())
    field=Ring(P)
    ...
    for case in residue['cases']:
        ...
        for orbit in case['frobeniusOrbits']:
            ...
            for precision in (2,3,4):
                ...
                rec['status']='UNRESOLVED_THROUGH_PRECISION_4'
            records.append(rec)
