...
def main():
    ...
    checks = [
        ('check_mod13_explanation.py', 'compact-check.json'),
        ('check_support_and_lift.py', 'support-and-lift-check.json'),
        ('supplement/verify_mod13.py', 'supplement/mod13-verification.json'),
    ]
    receipts = []
